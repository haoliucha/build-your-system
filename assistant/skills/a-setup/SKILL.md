---
name: a-setup
description: This skill should be used when the user request matches the former assistant workflow `a-setup`. [系统] 初始化 + 配置 - 验证 Vault 结构并完成设置
---

# Codex 适配说明

- 这是原 Claude assistant 命令 `a-setup` 的 Codex skill 版本。
