---
name: o-dashboard
description: This skill should be used when the user request matches the former assistant workflow `o-dashboard`. [Organize] 刷新 Dashboard - 更新统计、趋势、洞察数据
---

# Codex 适配说明

- 这是原 Claude assistant 命令 `o-dashboard` 的 Codex skill 版本。
...
```bash
python3 "${ASSISTANT_PLUGIN_ROOT:-$HOME/plugins/assistant}/scripts/analyze-codex-activity.py"
```
