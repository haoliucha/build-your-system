...
| Claude Code | `x/` | 2.2.1 | X (Twitter) 工具集:`/x:x-follow` 精准批量关注、`/x:x-unfollow` 互斥低频关注卫生、`/x:image` 经 Codex Rescue 生成文章封面和插图 |
...
| Codex | `targets/codex/build-your-system-assistant/` | 0.3.1 | Obsidian Vault 助手 + 与 Claude 同源的互斥低频 `x-unfollow` |
