...
```bash
node "${CLAUDE_PLUGIN_ROOT}/skills/single-source-sync/scripts/xlsx-dump.cjs" 手改版.xlsx > /tmp/a.tsv
node "${CLAUDE_PLUGIN_ROOT}/skills/single-source-sync/scripts/xlsx-dump.cjs" 重生成版.xlsx > /tmp/b.tsv
